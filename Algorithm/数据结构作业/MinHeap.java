...
public class MinHeap {
	 ...
	 * 
	* @Title: fixDown 
	* @Description: TODO 向下调整，顶端的大值往下调，主要用于删除和建堆
	* @param @param data
	* @param @param i i表示要调整的节点索引,删除时候，i是0，建堆时候i从最后一个节点的父节点依次往前调整
	* @param @param n  n表示堆的最后一个元素索引
	* @return void   
	* @throws
	 */
